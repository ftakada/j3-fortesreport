...
var
  ...
  b,n:TProgressBar;
begin
  inherited CreateNew(nil); { inherited CreateNew(nil); agora o Owner é a aplicação para
                                      evitar problemas com os Diálogos de Erro que ficavam por trás
                                      do Progress e também porque o Progress ficava no topo de todas
                                      as janelas }
  Init;
  //
...
procedure TfrmRLFeedBack.FormDeactivate(Sender: TObject);
begin
  if Visible then
    SetFocus;
end;
