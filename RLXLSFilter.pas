...
type
  ...
  {@type TRLXLSFilterOptions - Opções para a geração do arquivo planilha.
   ...
   foFindNumberCells - Tenta encontrar valores no relatório e formata as células correspondentes como numéricas. :}
...
begin
  ...
  begin
    ...
    begin
      ...
      if dcm > 0 then
         fFormat := AnsiString(StrFmtQuantidade(dcm));//Celso aqui também fui eu
    end
    else
      fDataType:=ctString;
  end;    
...
begin
  ...
  for i:=0 to aPage.ObjectCount-1 do
    ...
    begin
      ...
      {//Celso em 21/05/2011.
       Em aguns casos ficava da linha 1 até a zero e quando mesclava ficava errado e o excel não abria. O mesmo acontecia com as colunas
